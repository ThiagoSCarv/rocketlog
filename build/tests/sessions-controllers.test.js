...
// src/tests/sessions-controllers.test.ts
...
var UsersControllers = class {
  async create(request2, response, next) {
...
var usersController = new UsersControllers();
...
var sessionsControllers = new SessionsControllers();
...
var DeliveriesControllers = class {
  ...
  async index(request2, response, next) {
...
var DeliveriesStatusControllers = class {
...
var deliveriesStatusControllers = new DeliveriesStatusControllers();
...
var DeliveryLogsControllers = class {
  async create(request2, response) {
    ...
    if (delivery.status === "delivered") {
      throw new AppError("this order has already being delivered");
    }
...
var deliveryLogsControllers = new DeliveryLogsControllers();
